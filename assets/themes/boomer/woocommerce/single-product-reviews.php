...
add_action('wp_footer','msdlab_reviews_carousel',40);
function msdlab_reviews_carousel(){
    print '<script>
	...
	<div id="comments">
		<h2><?php
			if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' && ( $count = $product->get_review_count() ) )
				...
				printf('What people are saying about %s',get_the_title());
			else
...
<div id="reviews-carousel" class="carousel slide" data-ride="carousel">
  ...
  <ol class="carousel-indicators">
      ...
      $i = 0;
      while($i<$n){
          print '<li data-target="#reviews-carousel" data-slide-to="'.$i.'" class="active"></li>';
          $i++;
      } ?>
  </ol>

  <!-- Wrapper for slides -->
  <div class="carousel-inner commentlist" role="listbox">
